    ...
    public function calculateMetrics($type)
    {
        ...
        foreach ($players as $player) {
            ...
            if ($metrics['shuttle'] != null && $metrics['shuttle'] != '-' && $metrics['cone'] != null && $metrics['cone'] != "-") {
                ...
                $metrics['routeAgility'] = round(($metrics['cone'] * .7) + ($metrics['shuttle'] * 1.3),2);
                $metrics['jukeAgility'] = round(($metrics['shuttle'] * .8) + ($metrics['cone'] * 1.2), 2);
            } else {
            ...
            if (($metrics['shuttle'] != null && $metrics['shuttle'] != '-') && ($metrics['cone'] == null || $metrics['cone'] == "-")) {
                ...
                $metrics['routeAgility'] = round((($estCone * .7) + ($metrics['shuttle'] * 1.3)), 2);
            }
            ...
            if (($metrics['cone'] != null && $metrics['cone'] != '-') && ($metrics['shuttle'] == null || $metrics['shuttle'] == "-")) {
                ...
                $metrics['jukeAgility'] = round(($estShuttle * .8) + ($metrics['cone'] * 1.2), 2);
            }
